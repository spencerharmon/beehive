...
2. Author `submodules/<name>/ROI.md` (`beehive edit submodules/<name>/ROI.md
   --content-file <content>`, or the `beehived` editor UI) — the intent for this
   target. This is the only input a bootstrap pass needs. (See the `modify-roi`
   skill for ownership rules.)
